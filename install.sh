...
wget https://download.visualstudio.microsoft.com/do:qwnload/pr/10b96626-02d8-415a-be85-051a2a48d0c2/5ec51d3d9f092ba558fb5f1f03d26699/dotnet-sdk-2.1.403-linux-arm.tar.gz
mkdir -p /opt/dotnet 
tar zxf dotnet-sdk-2.1.403-linux-arm.tar.gz -C /opt/dotnet --checkpoint=.10
